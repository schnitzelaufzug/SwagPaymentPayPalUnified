...
class Backend implements SubscriberInterface
{
    ...
    public static function getSubscribedEvents()
    {
        return [
            ...
            'Enlight_Controller_Dispatcher_ControllerPath_Backend_PaypalUnifiedSubscriptions' => 'onGetBackendPaypalUnifiedSubscriptionsControllerPath',
        ];
    }
    ...
    /**
     * Handles the Enlight_Controller_Dispatcher_ControllerPath_Backend_PaypalUnifiedSubscriptions event.
     * Returns the path to the backend application controller.
     *
     * @return string
     */
    public function onGetBackendPaypalUnifiedSubscriptionsControllerPath()
    {
        return $this->pluginDirectory . '/Controllers/Backend/PaypalUnifiedSubscriptions.php';
    }
}
